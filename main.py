...
from confluent_kafka.admin import AdminClient, NewTopic # permite conectar kakfa en la nube
...
TOPIC_NAME = 'transactions_maryjaramillo' # Nombre del topic de Kafka
